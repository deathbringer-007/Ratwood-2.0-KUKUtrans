...
/datum/sex_action/chastityplay/masturbate_cage_penis/on_perform(mob/living/carbon/human/user, mob/living/carbon/human/target)
    user.sexcon_action_message(user.sexcon.spanify_force("[user][user.sexcon.get_generic_force_adjective()]让掌心沿着自己的[get_chastity_device_name(user)]上下摩擦，每一次来回都让阴茎徒劳地顶向栅栏......"))
