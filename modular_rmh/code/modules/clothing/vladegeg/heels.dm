/obj/item/clothing/shoes/roguetown/heels
	name = "黑色高跟鞋"	//Goes well with maids, nobles and desert sorceress outfit. I was planning to port the sound system later as well - Gardelin0
	desc = "能让穿戴者高高离开污泥的高跟鞋。可别崴脚。"
