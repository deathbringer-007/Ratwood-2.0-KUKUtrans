/datum/advclass/mercenary/rumaclan/seonjang
	...
	outfit = /datum/outfit/job/roguetown/mercenary/rumaclan_seonjang
...
/datum/outfit/job/roguetown/mercenary/rumaclan_seonjang/pre_equip(mob/living/carbon/human/H)
	..()
